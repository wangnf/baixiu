  ...
  $current_page = isset($current_page)?$current_page:'';
    // $current_user = $_SESSION['login_message'];
  ...
  <div class="aside">
    ...
    <ul class="nav">
      ...
      <?php $menu1 = array('post-add','categories','xiu_posts') ?>
      <li <?php echo in_array($current_page, $menu1)?'class="active"':''; ?>>
        <a href="#menu-posts" data-toggle="collapse">
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-posts" class="collapse <?php echo in_array($current_page, $menu)?' in':''; ?>">
          <li <?php echo $current_page === 'xiu_posts'?'class="active"':'';?>><a href="/admin/posts.php">所有文章</a></li>
      ...
      <?php $menu = array('nav-menus','slides','settings'); ?>
      <li <?php echo in_array($current_page, $menu)?'class="active"':''; ?>>
        <a href="#menu-settings" class="collapsed" data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-settings" class="collapse <?php echo in_array($current_page,$menu)?' in':''; ?>">
